...
Module.register("compliments", {
	...
	defaults: {
		compliments: {
			anytime: ["Salut Côme!"],
			morning: ["Bonjour le bg!", "Bonne journée !", "As-tu bien dormi?"],
			afternoon: ["Coucou Côme!", "T'es bg aujourd'hui!", "Tu es beau aujourd'hui!"],
			evening: ["Bonne soirée Côme!"],
